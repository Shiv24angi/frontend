      ...
      {result && (
        <div className="mt-8 p-6 rounded-2xl bg-gray-50 border border-gray-200 shadow-md">
          <p className="mb-3 text-lg">
            <span className="font-semibold text-gray-700">Daily Allowance:</span> <span className="text-green-600 font-bold">₹{result.dailyBudget.toFixed(2)}</span>
          </p>
          <p className="mb-3 text-lg">
            <span className="font-semibold text-gray-700">Remaining Savings:</span> <span className="text-gray-800 font-bold">₹{result.remainingSavings.toFixed(2)}</span>
          </p>
